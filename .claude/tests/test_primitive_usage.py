...
def test_should_block_when_raw_button_in_route(tmp_path: Path, monkeypatch) -> None:
...
def test_should_allow_when_raw_button_in_design_system(tmp_path: Path, monkeypatch) -> None:
...
def test_should_allow_when_input_outside_frontend(tmp_path: Path, monkeypatch) -> None:
