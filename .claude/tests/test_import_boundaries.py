...
def test_should_block_when_route_imports_internal(tmp_path: Path, monkeypatch) -> None:
...
def test_should_allow_when_design_system_imports_internal(tmp_path: Path, monkeypatch) -> None:
...
def test_should_block_when_frontend_imports_backend(tmp_path: Path, monkeypatch) -> None:
